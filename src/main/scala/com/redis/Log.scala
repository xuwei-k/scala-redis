...
trait Log {
 ...
 def trace(message:String, values:AnyRef*): Unit =
     log.trace(message, values.asInstanceOf[Seq[AnyRef]]: _*)
 ...
 def debug(message:String, values:AnyRef*): Unit =
     log.debug(message, values.asInstanceOf[Seq[AnyRef]]: _*)
 ...
 def info(message:String, values:AnyRef*): Unit =
     log.info(message, values.asInstanceOf[Seq[AnyRef]]: _*)
 ...
 def warn(message:String, values:AnyRef*): Unit =
     log.warn(message, values.asInstanceOf[Seq[AnyRef]]: _*)
 ...
 def error(message:String, values:AnyRef*): Unit =
     log.error(message, values.asInstanceOf[Seq[AnyRef]]: _*)
